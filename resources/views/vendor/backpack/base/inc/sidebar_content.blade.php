...
<li class="nav-item nav-dropdown">
        ...
        <ul class="nav-dropdown-items">
                <li class='nav-item'><a class='nav-link' href='{{ backpack_url('page') }}'>
                                <i class="nav-icon lab la-leanpub"></i>Applications</a></li>
...
@endif
@endif
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('layanan') }}'><i class='nav-icon la la-question'></i> Layanans</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('permohonan') }}'><i class='nav-icon la la-question'></i> Permohonans</a></li>